...
/*const miDiv = document.getElementsByClassName('main-div')[0]
console.log(miDiv);*/

/*const miDiv = document.querySelector('.main-div')
console.log(miDiv.innerHTML);
console.log(miDiv.innerText);
console.log(miDiv);*/
 ...
 */
/*let miImg = document.querySelectorAll('img')[0]
console.log(miImg);
...
/*let query = document.querySelector('#titulo')
console.log(query);
